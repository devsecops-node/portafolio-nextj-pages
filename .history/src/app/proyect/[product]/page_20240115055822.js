...
export default function Page({ params }) {
  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center w-[80%] mr-auto ml-auto relative ">
      ...
      <p className="text-[10px] z-40 transition-all hover:text-[15px] hover:text-black duration-150">{proyect.reflexion}</p>
      ...
      <div className="flex flex-row gap-3 mt-[20px] items-center justify-center">
        ...
        <CiFacebook className="text-[40px] text-sky-700"/>
        <CiLinkedin className="text-[40px] text-sky-800"/>
      </div>
