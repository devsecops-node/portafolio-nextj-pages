    ...
    <>
      {proyect ?
        (<div className="h-screen flex flex-col justify-center items-center w-[80%] mr-auto ml-auto relative ">
          ...
          <img src={proyect.imagen} alt="imagen-semana" className='z-0 blur-sm opacity-50 bg-slate-400 flex rounded-md absolute animate-pulse ' />
          <p>Resumen</p>
          ...
          <div className="text-sky-600 font-bold mt-[20px] animate-bounce">
            Home ↗️
          </div>
