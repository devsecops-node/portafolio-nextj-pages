      ...
      {proyect ?
        ...
        (
          <div className="h-screen flex flex-col justify-center items-center mt-auto mb-auto">
            ...
            <img className="animate-bounce" src="https://static.vecteezy.com/system/resources/previews/005/238/451/non_2x/internet-network-warning-404-error-page-or-file-not-found-for-web-page-free-vector.jpg" alt="" />
          </div>
        )}
    </>
  )
