...
export default function Page({ params }) {
  ...
  // console.log(proyect)
  return (
    <div className="h-screen flex flex-col justify-center items-center w-[80%] mr-auto ml-auto relative z-20">
      ...
      <img src={proyect.imagen} alt="imagen-semana" width={100} className='bg-slate-400 flex rounded-md absolute ' />
    </div>
  )
}