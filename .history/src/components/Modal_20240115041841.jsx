  ...
  return (
    <div className='absolute z-10 bg-slate-200 h-screen w-[100%] flex flex-col justify-center items-center' onClick={close}>
      ...
      <div class="card w-[50%]">
        ...
        <button onClick={close} className='bg-blue-600 p-2 rounded-md text-white hover:scale-105 duration-150 ease-in-out flex justify-center items-center'>Close</button>
      </div>
    </div>
  )
}
