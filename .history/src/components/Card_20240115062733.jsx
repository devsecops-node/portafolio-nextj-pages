...
const Card = ({ proyect }) => {
  return (
    <Link href={`/product/${proyect.id}`} className='bg-slate-300 p-2 flex flex-col gap-1 rounded-md transition-all duration-150 hover:scale-105 ease-in-out hover:z-20 hover:border cursor-pointer'>
