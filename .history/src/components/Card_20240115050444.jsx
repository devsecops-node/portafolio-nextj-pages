...
const Card = ({ proyect }) => {
  return (
    <section className='bg-slate-300 p-2 rounded-md transition-all duration-150 hover:scale-105 ease-in-out hover:z-20 hover:border cursor-pointer'>
      <img src={proyect.imagen} alt="imagen-semana" width={100} height={100} className='bg-slate-400 flex rounded-sm' />
