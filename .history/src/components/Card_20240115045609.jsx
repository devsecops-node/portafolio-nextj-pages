...
const Card = ({ proyect }) => {
  return (
    <section className='bg-slate-300 p-2 rounded-md'>
      <img src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fthenewstack.io%2Fthis-week-in-programming-visual-studio-code-arrives-on-the-web%2F&psig=AOvVaw0jfTrsgnH-LWmY5dLgk3ih&ust=1705398957951000&source=images&cd=vfe&opi=89978449&ved=0CBMQjRxqFwoTCPCxwKuQ34MDFQAAAAAdAAAAABAD" alt="imagen-semana" width={100} height={100} className='bg-slate-400' />
