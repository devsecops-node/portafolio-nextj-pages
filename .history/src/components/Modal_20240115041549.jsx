      ...
      <div class="card w-[50%]">
        ...
        <ul >
          ...
          <li><strong>Experiencia Técnica:</strong>
            <ul>
              <li>Experiencia en el desarrollo de aplicaciones utilizando tecnologías front-end como React y Angular, lo que demuestra habilidades en la creación de interfaces de usuario dinámicas y atractivas.</li>
