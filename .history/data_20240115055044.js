...
export const proyectos = [
  {
    ...
    resumen_de_clase: "La tecnología web, un universo digital que conecta al mundo, se compone de lenguajes de programación como <strong>HTML</strong>, <strong>CSS</strong> y <strong>JavaScript</strong>. Los desarrolladores <em>frontend</em> dan forma a la apariencia y la interactividad, mientras que los <em>backend</em> construyen la infraestructura. Los <em>fullstack</em> desarrolladores son maestros en ambas disciplinas. El <strong>DNS</strong> dirige nuestras solicitudes digitales, el Protocolo <strong>TCP/IP</strong> y <strong>HTTP</strong> gobiernan la comunicación, y <strong>Visual Studio Code</strong> sirve como la herramienta central para el desarrollo web. En el laboratorio 01A, exploramos los elementos de VSC, sus extensiones y atajos de teclado. En este vasto océano digital, los desarrolladores son navegantes que exploran nuevas posibilidades, tejiendo el tapiz de la web y dando forma al futuro digital con creatividad e innovación.    ",
